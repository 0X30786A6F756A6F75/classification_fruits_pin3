    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-sm-10">
          <h1 className="title mb-8">Envie o seu CSV e descubrar o tipo de frutas</h1>
          <p className="text-center">Envie um arquivo CSV conforme os campos da tabela abaixo:</p>
